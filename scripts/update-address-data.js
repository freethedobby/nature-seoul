...
async function updateAddressData() {
  try {
    ...
    const dongs = {
      // 서울 종로구
      jongno: [
        { value: "cheongun", label: "청운동" },
        { value: "singyo", label: "신교동" },
        { value: "gungjeong", label: "궁정동" },
        { value: "hyoja", label: "효자동" },
        { value: "changseong", label: "창성동" },
        { value: "tongui", label: "통의동" },
        { value: "jeokseon", label: "적선동" },
        { value: "tongin", label: "통인동" },
        { value: "nusang", label: "누상동" },
        { value: "nuha", label: "누하동" },
        { value: "okin", label: "옥인동" },
        { value: "chebu", label: "체부동" },
        { value: "pilun", label: "필운동" },
        { value: "naeja", label: "내자동" },
        { value: "sajik", label: "사직동" },
        { value: "doryeom", label: "도렴동" },
        { value: "dangju", label: "당주동" },
        { value: "naesu", label: "내수동" },
        { value: "sejongno", label: "세종로" },
        { value: "sinmunno", label: "신문로" },
        { value: "cheongjin", label: "청진동" },
        { value: "seorin", label: "서린동" },
        { value: "susong", label: "수송동" },
        { value: "junghak", label: "중학동" },
        { value: "jongno1", label: "종로1가" },
        { value: "gongpyeong", label: "공평동" },
        { value: "gwancheol", label: "관철동" },
        { value: "gyeonji", label: "견지동" },
        { value: "gwonnong", label: "권농동" },
        { value: "unni", label: "운니동" },
        { value: "ikseon", label: "익선동" },
        { value: "gyeongun", label: "경운동" },
        { value: "gwanhun", label: "관훈동" },
        { value: "insa", label: "인사동" },
        { value: "nakwon", label: "낙원동" },
        { value: "waryong", label: "와룡동" },
        { value: "hunjung", label: "훈정동" },
        { value: "myo", label: "묘동" },
        { value: "bongik", label: "봉익동" },
        { value: "donui", label: "돈의동" },
        { value: "jangsa", label: "장사동" },
        { value: "gwansu", label: "관수동" },
        { value: "jongno2", label: "종로2가" },
        { value: "jongno3", label: "종로3가" },
        { value: "jongno4", label: "종로4가" },
        { value: "hyoje", label: "효제동" },
        { value: "jongno5", label: "종로5가" },
        { value: "jongno6", label: "종로6가" },
        { value: "ihwa", label: "이화동" },
        { value: "yeonji", label: "연지동" },
        { value: "chungsin", label: "충신동" },
        { value: "hyehwa", label: "혜화동" },
        { value: "myeongnyun", label: "명륜동" },
      ],
      // 서울 중구
      junggu: [
        { value: "mugyo", label: "무교동" },
        { value: "dadong", label: "다동" },
        { value: "taepyeongno", label: "태평로" },
        { value: "namdaemunno", label: "남대문로" },
        { value: "bongnae", label: "봉래동" },
        { value: "euljiro", label: "을지로" },
        { value: "jeongdong", label: "정동" },
        { value: "sunhwa", label: "순화동" },
        { value: "uijuro", label: "의주로" },
        { value: "chungjeongro", label: "충정로" },
        { value: "jungnim", label: "중림동" },
        { value: "yejang", label: "예장동" },
        { value: "hoehyun", label: "회현동" },
        { value: "chungmuro", label: "충무로" },
        { value: "pildong", label: "필동" },
      ...
      // 서울 광진구
      gwangjin: [
        { value: "junggok", label: "중곡동" },
        { value: "neung", label: "능동" },
        { value: "gunja", label: "군자동" },
        { value: "hwayang", label: "화양동" },
        { value: "jayang", label: "자양동" },
        { value: "goui", label: "구의동" },
      ],
      // 서울 동대문구
      dongdaemun: [
        { value: "yongdu", label: "용두동" },
        { value: "jegi", label: "제기동" },
        { value: "jeonnong", label: "전농동" },
        { value: "dapsimni", label: "답십리동" },
        { value: "jangan", label: "장안동" },
        { value: "cheongnyangni", label: "청량리동" },
        { value: "hoegi", label: "회기동" },
        { value: "hwigyeong", label: "휘경동" },
        { value: "imun", label: "이문동" },
      ],
      // 서울 중랑구
      jungnang: [
        { value: "myeonmok", label: "면목동" },
        { value: "sangbong", label: "상봉동" },
        { value: "junghwa", label: "중화동" },
        { value: "muk", label: "묵동" },
        { value: "mangu", label: "망우동" },
        { value: "sinae", label: "신내동" },
      ],
      // 서울 성북구
      seongbuk: [
        ...
        { value: "donam", label: "돈암동" },
        { value: "anam", label: "안암동" },
        { value: "bomun", label: "보문동" },
        { value: "jeongneung", label: "정릉동" },
        { value: "gireum", label: "길음동" },
        { value: "jongam", label: "종암동" },
        { value: "wolgok", label: "월곡동" },
        { value: "jangwi", label: "장위동" },
      ...
      gangbuk: [
        { value: "mia", label: "미아동" },
        { value: "beon", label: "번동" },
        { value: "suyu", label: "수유동" },
        { value: "ui", label: "우이동" },
      ],
      // 서울 도봉구
      dobong: [
        { value: "ssangmun", label: "쌍문동" },
        { value: "banghak", label: "방학동" },
        { value: "chang", label: "창동" },
        { value: "dobong", label: "도봉동" },
      ],
      // 서울 노원구
      nowon: [
        { value: "wolgye", label: "월계동" },
        { value: "gongneung", label: "공릉동" },
        { value: "hagye", label: "하계동" },
        { value: "junggye", label: "중계동" },
        { value: "sanggye", label: "상계동" },
      ],
      // 서울 은평구
      eunpyeong: [
        { value: "nokbeon", label: "녹번동" },
        { value: "bulgwang", label: "불광동" },
        { value: "galhyeon", label: "갈현동" },
        { value: "gusan", label: "구산동" },
        { value: "daejo", label: "대조동" },
        { value: "eungam", label: "응암동" },
      ...
      seodaemun: [
        { value: "chungjeongro", label: "충정로" },
        { value: "naengcheon", label: "냉천동" },
        { value: "cheonyeon", label: "천연동" },
        { value: "bukahyeon", label: "북아현동" },
        { value: "chunghyeon", label: "충현동" },
        { value: "hap", label: "합동" },
        { value: "hyeonjeo", label: "현저동" },
        { value: "daehyeon", label: "대현동" },
        { value: "daesin", label: "대신동" },
        { value: "sinchon", label: "신촌동" },
        { value: "yeonhui", label: "연희동" },
        { value: "hongeun", label: "홍은동" },
        { value: "namgajwa", label: "남가좌동" },
        { value: "bukgajwa", label: "북가좌동" },
      ],
      // 서울 마포구
      mapo: [
      ...
      yangcheon: [
        { value: "mok", label: "목동" },
        { value: "sinjeong", label: "신정동" },
        { value: "sinwol", label: "신월동" },
      ],
      // 서울 강서구
      gangseo: [
        ...
        { value: "balsan", label: "발산동" },
        { value: "banghwa", label: "방화동" },
        { value: "gonghang", label: "공항동" },
        { value: "magok", label: "마곡동" },
        { value: "gaehwa", label: "개화동" },
        { value: "gwaha", label: "과해동" },
        { value: "ogok", label: "오곡동" },
        { value: "osoe", label: "오쇠동" },
      ],
      // 서울 구로구
      guro: [
        { value: "sindorim", label: "신도림동" },
        { value: "guro", label: "구로동" },
        { value: "garibong", label: "가리봉동" },
        { value: "gocheok", label: "고척동" },
        { value: "gaebong", label: "개봉동" },
        { value: "oryu", label: "오류동" },
        { value: "gung", label: "궁동" },
        { value: "onsu", label: "온수동" },
        { value: "cheonwang", label: "천왕동" },
        { value: "hang", label: "항동" },
      ],
      // 서울 금천구
      geumcheon: [
        { value: "gasan", label: "가산동" },
        { value: "doksan", label: "독산동" },
      ...
      yeongdeungpo: [
        ...
        { value: "yangpyeong", label: "양평동" },
        { value: "munrae", label: "문래동" },
        { value: "dorim", label: "도림동" },
        { value: "singil", label: "신길동" },
        { value: "daerim", label: "대림동" },
        { value: "yanghwa", label: "양화동" },
      ],
      // 서울 동작구
      dongjak: [
        { value: "noryangjin", label: "노량진동" },
        { value: "sangdo", label: "상도동" },
        { value: "daebang", label: "대방동" },
        { value: "bon", label: "본동" },
        { value: "heukseok", label: "흑석동" },
        { value: "sadang", label: "사당동" },
        { value: "sindaebang", label: "신대방동" },
      ],
      // 서울 관악구
      gwanak: [
        { value: "bongcheon", label: "봉천동" },
        { value: "sinrim", label: "신림동" },
      ...
      // 서울 강동구
      gangdong: [
        { value: "myeongil", label: "명일동" },
        { value: "godeok", label: "고덕동" },
        { value: "sangil", label: "상일동" },
        { value: "gil", label: "길동" },
        { value: "dunchon", label: "둔촌동" },
        { value: "amsa", label: "암사동" },
        { value: "cheonho", label: "천호동" },
        { value: "seongnae", label: "성내동" },
      ],
      // 경기도 수원시
      suwon: [
